#!/usr/bin/env python3
"""Patch: replace kiosk idle screen icon + update button styles"""
...
assert old_block in src, "FAIL: idle screen block not found"
...
for kw in ['kscan', 'kblink', '用手機相機掃描', 'QR Code 對準']:
